...
<required_reading>
@/home/user/insta-code/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/insta-code/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/insta-code/.claude
                  → checks /home/user/insta-code/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/insta-code/.claude/get-shit-done
                  → writes to /home/user/insta-code/.claude/get-shit-done/hooks/
...
@/home/user/insta-code/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/insta-code/.claude/get-shit-done/references/common-bug-patterns.md
