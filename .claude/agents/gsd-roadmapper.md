...
Reference full template: `/home/user/insta-code/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/insta-code/.claude/get-shit-done/templates/state.md`.
