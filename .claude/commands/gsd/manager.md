...
<execution_context>
@/home/user/insta-code/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/insta-code/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
