...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/insta-code/.claude/.gsd-surface.json`
(sibling to `/home/user/insta-code/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/insta-code/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/insta-code/.claude/skills`).
...
`/home/user/insta-code/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/insta-code/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/insta-code/.claude/.gsd-surface.json`
Install profile marker: `/home/user/insta-code/.claude/.gsd-profile`
Skill dirs: `/home/user/insta-code/.claude/skills/gsd-*/`
Engine module: `/home/user/insta-code/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/insta-code/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
