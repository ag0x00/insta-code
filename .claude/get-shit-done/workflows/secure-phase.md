...
```
Agent(
  prompt="Read /home/user/insta-code/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/insta-code/.claude/get-shit-done/templates/SECURITY.md`
