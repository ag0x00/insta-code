...
```markdown
Read /home/user/insta-code/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/insta-code/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/insta-code/.claude/agents/gsd-ui-checker.md for instructions.
