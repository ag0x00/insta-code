...
| Saved-collection sync — **opt-in, off by default**, cookie-based, small batches w/ **randomized delays** (jitter) | Convenient capture of the saved collection, but carries real account-ban risk (per research PDF); randomized delays avoid a mechanical fixed-interval pattern; user opts in knowingly | ✅ Adopted 2026-05-26 (opt-in, Phase 1) |
